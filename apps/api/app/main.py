...
from .routers import ai_usage, home_camera as home_camera_router, settings as settings_router, storage as storage_router
...
app.include_router(home_camera_router.router)
